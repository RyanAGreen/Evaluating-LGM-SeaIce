...
AMOC_depth_PMIP3 = [2333,3230,2273,2980,2745,1993,3363,2940]
AMOC_strength_PMIP3 = [21.53, 31.64,21.76,21.37,22.07,23.04,22.32,22.74]
...
seaicearea_PMIP4_small = [seaicearea_PMIP4[0],seaicearea_PMIP4[2],seaicearea_PMIP4[3],seaicearea_PMIP4[4],seaicearea_PMIP4[6]]
AMOC_depth_PMIP4 = []

# Right now I have UoT-CCSM4,LOVECLIOM,AWI,MPI, MIROC
AMOC_strength_PMIP4 = [18,26,16,24,21]
...
AMOC_depth_LOVE = [1600, 2200]
AMOC_strength_LOVE = [11.2, 14.7]
...
seaicearea_total_test = seaicearea_PMIP3 + seaicearea_LOVE
seaicearea_total_test1 = seaicearea_PMIP3 + seaicearea_LOVE +seaicearea_PMIP4_small
AMOC_depth_total = AMOC_depth_PMIP3 + AMOC_depth_PMIP4 + AMOC_depth_LOVE
AMOC_strength_total = AMOC_strength_PMIP3 + AMOC_strength_PMIP4 + AMOC_strength_LOVE
...
# linear fit for sea ice area vs AMOC depth
fit = np.polyfit(seaicearea_total_test,AMOC_depth_total,1)
ang_coeff = fit[0]
intercept = fit[1]
fit_AMOCdepth = ang_coeff*np.asarray(seaicearea_total_test) + intercept

# linear fit for sea ice area vs AMOC strength
fit = np.polyfit(seaicearea_total_test1,AMOC_strength_total,1)
ang_coeff = fit[0]
intercept = fit[1]
fit_AMOCstrength = ang_coeff*np.asarray(seaicearea_total_test) + intercept
...
plt.plot(proxySST,proxyseaiceedge,'ko',fillstyle='none',markersize=96,alpha=0.3)
...
# labeling
plt.grid()
plt.xlabel('SST (˚ C)',fontweight='bold',fontsize=13)
...
plt.plot(proxySST,proxyseaicearea,'ko',fillstyle='none',markersize=96,alpha=0.3)
for i in range(len(seaiceedge_PMIP3)):
...
# AMOC strength vs SIE
plt.subplot(4,2,3)
for i in range(len(AMOC_strength_PMIP3)):
    plt.plot(seaicearea_PMIP3[i],AMOC_strength_PMIP3[i],marker='^',markersize=8,markeredgecolor='k',color=colorsPMIP3[i],zorder=4)
for i in range(len(AMOC_strength_PMIP4)):
    plt.plot(seaicearea_PMIP4_small[i],AMOC_strength_PMIP4[i],marker='s',markersize=8,markeredgecolor='k',color=colorsPMIP4[i])
# no for loop for love because two different symbols
plt.plot(seaicearea_LOVE[0],AMOC_strength_LOVE[0],marker='X',markersize=8,color=colorsLOVE[0],markeredgecolor='k')
plt.plot(seaicearea_LOVE[1],AMOC_strength_LOVE[1],marker='P',markersize=8,color=colorsLOVE[0],markeredgecolor='k')
plt.plot(seaicearea_total_test,fit_AMOCstrength,'grey',zorder=0)
plt.grid()
plt.ylabel('AMOC strength (Sv)',fontweight='bold',fontsize=15)
plt.xlabel('Sea ice extent (10$^6$ km$_2$) ',fontweight='bold',fontsize=13)
plt.tick_params(bottom=True, top=True, left=True, right=True)
plt.tick_params(axis='both', direction="in", length=7, width=3, color="black")
...
# AMOC depth vs SIE
plt.subplot(4,2,4)
for i in range(len(AMOC_depth_PMIP3)):
    plt.plot(seaicearea_PMIP3[i],AMOC_depth_PMIP3[i],marker='^',markersize=8,markeredgecolor='k',color=colorsPMIP3[i],zorder=4)
# for i in range(len(AMOC_depth_PMIP4)):
#     plt.plot(seaicearea_PMIP3[i],seaiceedge_PMIP4[i],marker='s',markersize=8,markeredgecolor='k',color=colorsPMIP4[i])
# no for loop for love because two different symbols
plt.plot(seaicearea_LOVE[0],AMOC_depth_LOVE[0],marker='X',markersize=8,color=colorsLOVE[0],markeredgecolor='k')
plt.plot(seaicearea_LOVE[1],AMOC_depth_LOVE[1],marker='P',markersize=8,color=colorsLOVE[0],markeredgecolor='k')
plt.plot(seaicearea_total_test,fit_AMOCdepth,'grey',zorder=0)
plt.grid()
plt.ylabel('AMOC depth (m)',fontweight='bold',fontsize=15)
plt.xlabel('Sea ice extent (10$^6$ km$_2$) ',fontweight='bold',fontsize=13)
plt.tick_params(bottom=True, top=True, left=True, right=True)
plt.tick_params(axis='both', direction="in", length=7, width=3, color="black")
